...
```
$ npm install moleculer-browser
```

## <a name="usage"></a> Usage

```javascript
const { ServiceBroker } = require('moleculer-browser')
...
:bug: If you found an issue we encourage you to report it on [github](https://github.com/icebob/moleculer-browser/issues). Please specify your OS and the actions to reproduce it.

## <a name="contribute"></a> Contributing

:busts_in_silhouette: Ideas and contributions to the project are welcome. You must follow this [guideline](https://github.com/icebob/moleculer-browser/blob/main/CONTRIBUTING.md).

## License

MIT © [icebob](https://github.com/icebob)
